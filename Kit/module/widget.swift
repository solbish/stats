...
public enum widget_t: String {
    ...
    case state = "state"
    case text = "text"
    case claudeIndicator = "claude_indicator"
    ...
    public func new(module: String, config: NSDictionary, defaultWidget: widget_t) -> SWidget? {
        ...
        case .claudeIndicator:
            preview = ClaudeIndicator(title: module, preview: true)
            item = ClaudeIndicator(title: module, preview: false)
        default: break
        }
    ...
    public func name() -> String {
        ...
        case .claudeIndicator: return localizedString("Claude indicator")
        default: return ""
        }
    }
}
